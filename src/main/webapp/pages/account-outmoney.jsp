                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        ...
                                        <input id="money" type="text" class="form-control"  value="${account.money}" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon">$</span>
                                        <input id="outmoney" type="text" class="form-control" placeholder="金额">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input id="outpassword" type="password" class="form-control" placeholder="密码" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="againoutpassword" class="col-sm-2 control-label">再次输入密码:</label>
                                <div class="col-sm-5">
                                    <input id="againoutpassword" type="password" class="form-control" placeholder="密码" value="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function Outmoney() {
        ...
        if (outMoney == ""||outMoney<=0) {
            //alert("用户名账号不能为空，请输入.");
            layer.msg("取出的金额有误.", {time: 2000, icon: 5, shift: 6}, function () {
            });
            return;
        }
        if (outMoney > ${account.money}) {
            layer.msg("取出的金额不能大于余额.", {time: 2000, icon: 5, shift: 6}, function () {
            });
            return;
        }

        var pswd = $("#outpassword").val();
        if (pswd == "") {
            //alert("用户名密码不能为空，请输入.");
        ...
        var againpswd = $("#againoutpassword").val();
        if (againpswd == "") {
            //alert("用户名密码不能为空，请输入.");
