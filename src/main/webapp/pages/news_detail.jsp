				...
				<div class="col-md-6">
					...
					<div class="box box-success">
						<div class="box-header with-border">
							<div class="user">
								<span class="username"><h3>${news.nTitle}</h3></span>
								<span class="description"><fmt:formatDate pattern="yyyy年 MM月 dd日" value="${news.nDate}"></fmt:formatDate>
                        </span></span>
							</div>
