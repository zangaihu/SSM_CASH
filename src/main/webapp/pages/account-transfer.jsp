        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="modal-content">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon">￥</span>
                                        <input id="transfermoney" type="text" class="form-control" placeholder="金额">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="transferAccount" class="col-sm-2 control-label">转账用户Id:</label>
                                <div class="col-sm-5">
                                    <input id="transferAccount" type="text" class="form-control" placeholder="用户账户id" value="">
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <div  class="col-md-1 "align="right" style="float:right">
                        <button onclick="transfermoney()" type="button" class="btn btn-block btn-success " data-dismiss="modal">确定</button>
                    </div>
...
<script>
    ...
    function transfermoney() {
        ...
        if (transferMoney == ""||transferMoney<=0) {
            //alert("用户名账号不能为空，请输入.");
            layer.msg("转账的金额有误.", {time: 2000, icon: 5, shift: 6}, function () {
            });
            return;
        }
        ...
        if (transferAccount == "") {
            //alert("用户名账号不能为空，请输入.");
            layer.msg("入账用户不能为空.", {time: 2000, icon: 5, shift: 6}, function () {
            });
            return;
        }
        ...
        {
            layer.msg("该用户尚未开户，不能进行转账操作", {time: 2000, icon: 5, shift: 6}, function () {
            });
            return;
        }
        $.ajax({
