							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="timeline">
									...
									<ul class="timeline timeline-inverse">
										<!-- timeline time label -->
										<li class="time-label">
                                            <span id="datecolor" class="bg-yellow-active">
										...
										<li>
											...
											<div class="timeline-item">
												...
												<h3 class="timeline-header"><a href="/news/get_news_detail_user?nId=${news.nId}">${news.nTitle}</a></h3>
												...
												<div class="timeline-footer">
													<a class="btn btn-primary btn-xs" href="/news/get_news_detail_user?nId=${news.nId}">Read more</a>
												</div>
											</div>
										</li>
