								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="account">
										<tr>
											<td>${account.aId}</td>
											<td>${account.aName}</td>
											<td>${account.aIndentity}</td>
											<td>${account.aState}</td>

											<td class="text-center">
												<button type="button" class="btn bg-danger btn-sm" onclick="location.href='/department/to_update?sn=${dept.sn}'">编辑</button>
