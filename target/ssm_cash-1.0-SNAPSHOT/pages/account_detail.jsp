				...
				<div class="box box-primary">
					...
					<div class="panel panel-info">
						<div class="panel-body">
							<form class="form-inline" action="/account/get_accountdetail_select" method="post">
								...
								<tbody>
									...
									<c:forEach items="${pageInfo.list}" var="account">
										<tr>
											...
											<td>${account.aPhone}</td>
											<td>${account.aIdentity}</td>
<%--											<td>${account.createtime}</td>--%>
											<td><fmt:formatDate pattern="yyyy-MM-dd" value="${account.createtime}"></fmt:formatDate></td>
											<td>${account.money}</td>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="/account/get_detail?pn=1" aria-label="Previous">首页</a></li>

								<c:if test="${pageInfo.hasPreviousPage}">
									<li><a href="/account/get_detail?pn=${pageInfo.pageNum-1}"><span aria-hidden="true">&laquo;</span></a></li>
								</c:if>

								<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">

									<c:if test="${page_num == pageInfo.pageNum}">
										<li class="active"><a href="/account/get_detail?pn=${page_num}">${page_num}</a></li>
									</c:if>
									<c:if test="${page_num != pageInfo.pageNum}">
										<li><a href="/account/get_detail?pn=${page_num}">${page_num}</a></li>
									</c:if>
								</c:forEach>
								<c:if test="${pageInfo.hasNextPage}">
									<li><a href="/account/get_detail?pn=${pageInfo.pageNum+1}"><span aria-hidden="true">&raquo;</span></a></li>
								</c:if>

								<li><a href="/account/get_detail?pn=${pageInfo.pages}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
